...
| --- | --- | --- | --- | --- |
| [`bottom`](https://github.com/tusen-ai/naive-ui/blob/42a52e6436b38bed456fee19eb0b89cdcd00fcc2/src/float-button/demos/enUS/index.demo-entry.md#L24) | Prop | --m-float-block-end CSS length/auto. | 🟢 Verified ADAPTED target | Source has no bottom default; native dock offsets are explicit, not an automatic 40px placement. |
| [`height`](https://github.com/tusen-ai/naive-ui/blob/42a52e6436b38bed456fee19eb0b89cdcd00fcc2/src/float-button/demos/enUS/index.demo-entry.md#L25) | Prop | --m-float-height minimum block size, default 2.5rem. | 🟢 Verified ADAPTED target | Source applies minHeight; native descriptions can grow. Fixed popover trigger has a separately explicit shared size. |
| [`left`](https://github.com/tusen-ai/naive-ui/blob/42a52e6436b38bed456fee19eb0b89cdcd00fcc2/src/float-button/demos/enUS/index.demo-entry.md#L26) | Prop | --m-float-inline-start CSS length/auto. | 🟢 Verified ADAPTED target | Logical axis, no numeric/style-object parser or forced physical direction. |
...
| [`right`](https://github.com/tusen-ai/naive-ui/blob/42a52e6436b38bed456fee19eb0b89cdcd00fcc2/src/float-button/demos/enUS/index.demo-entry.md#L29) | Prop | --m-float-inline-end CSS length/auto. | 🟢 Verified ADAPTED target | Logical RTL placement and safe-area clearances checked; no callback measurement. |
...
| [`top`](https://github.com/tusen-ai/naive-ui/blob/42a52e6436b38bed456fee19eb0b89cdcd00fcc2/src/float-button/demos/enUS/index.demo-entry.md#L32) | Prop | --m-float-block-start CSS length/auto. | 🟢 Verified ADAPTED target | Native offset/containing-block behavior; no geometry parser. |
...
| [`width`](https://github.com/tusen-ai/naive-ui/blob/42a52e6436b38bed456fee19eb0b89cdcd00fcc2/src/float-button/demos/enUS/index.demo-entry.md#L34) | Prop | --m-float-width CSS length; source-aligned default 2.5rem. | 🟢 Verified ADAPTED target | 40px source default reconciled despite public table undefined; larger authored lengths supported without JS conversion. |
...
| Upstream item · source | Kind | Retained MarkupUI mapping | Status | Evidence / boundary |
| --- | --- | --- | --- | --- |
| [`bottom`](https://github.com/tusen-ai/naive-ui/blob/42a52e6436b38bed456fee19eb0b89cdcd00fcc2/src/float-button/demos/enUS/index.demo-entry.md#L41) | Prop | Group --m-float-block-end CSS length/auto. | 🟢 Verified ADAPTED target | Authored group offset; grouped child actions stay relative. |
| [`left`](https://github.com/tusen-ai/naive-ui/blob/42a52e6436b38bed456fee19eb0b89cdcd00fcc2/src/float-button/demos/enUS/index.demo-entry.md#L42) | Prop | Group --m-float-inline-start CSS length/auto. | 🟢 Verified ADAPTED target | Logical axis without DOM reversal or measurement. |
...
| [`right`](https://github.com/tusen-ai/naive-ui/blob/42a52e6436b38bed456fee19eb0b89cdcd00fcc2/src/float-button/demos/enUS/index.demo-entry.md#L44) | Prop | Group --m-float-inline-end CSS length/auto. | 🟢 Verified ADAPTED target | Logical end offset with containing-block constraints. |
...
| [`top`](https://github.com/tusen-ai/naive-ui/blob/42a52e6436b38bed456fee19eb0b89cdcd00fcc2/src/float-button/demos/enUS/index.demo-entry.md#L46) | Prop | Group --m-float-block-start CSS length/auto. | 🟢 Verified ADAPTED target | Native offset value; no source style-object/number forwarding. |

### FloatButton Slots

| Upstream item · source | Kind | Retained MarkupUI mapping | Status | Evidence / boundary |
| --- | --- | --- | --- | --- |
| [`description`](https://github.com/tusen-ai/naive-ui/blob/42a52e6436b38bed456fee19eb0b89cdcd00fcc2/src/float-button/demos/enUS/index.demo-entry.md#L52) | Slot | Authored .m-float-description inside the native action. | 🟢 Verified ADAPTED target | Visible labels/phrasing content and native names remain; no VNode slot renderer. |
