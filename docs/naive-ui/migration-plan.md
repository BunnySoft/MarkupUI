...
| P3 — Interaction foundations | 🟠 In progress | Popover/Tooltip/Popconfirm/Dropdown/Menu/Tabs/Collapse/Anchor retained scopes accepted; Back Top and remaining P3 components are not complete. | P0 lifecycle; P1 controls | Nested interaction, dismissal and focus behavior are defined and demonstrated per component. |
...
| P3-05 — Navigation | 🟠 In progress | Dropdown, Menu, Tabs, Collapse and Anchor retained scopes accepted; Back Top is next. | Native links/disclosures/scroll locations; no router or option renderer. |
...
**Next: Back Top (P3); separate implementation/acceptance/commit.**
...
The index records 3,280 rows and 168 accepted retained tasks out of 384 across 42 component
pages (216 unchecked), not full upstream parity.
...
conventions are reused without dependencies; Back Top is next and can share the concrete
native scroll context. P3 remains incomplete.
...
### Remaining P3 inventory after Anchor

The Image catalog check left 19 Planned P3-assigned components. Popover, Tooltip,
Popconfirm, Dropdown, Menu, Tabs, Collapse and Anchor now close four tasks each; **11 P3-assigned components remain Planned**:

- **P3 disclosure:** Collapse Transition.
- **P3 navigation:** Back Top, Pagination, Steps.
- **P3 overlays/feedback:** Loading Bar, Dialog, Drawer, Message, Modal, Notification.
- **P3; exclusions:** Discrete API.

**Back Top is next**. Accepted Popover/Tooltip/Popconfirm/Dropdown/Menu/Tabs/Collapse/Anchor retained scopes
...
No Back Top or CollapseTransition implementation is added in this Anchor change.
