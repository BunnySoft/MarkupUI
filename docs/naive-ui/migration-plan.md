...
verified no-new-runtime composition resolution. P4 is In progress with Input, Checkbox, Radio, Switch, Select and Input Number
native scopes accepted and 11 routes Planned. P0/P5/P6 and full framework/viewer
...
| P4 — Forms and selection | 🟠 In progress | Input, Checkbox, Radio, Switch, native Select and Input Number accepted; Slider next. | Relevant P0 form contract; P3 for popup variants | Native values/defaults/selection/numeric stepping/forms and events documented; no Form-level validation or rich P5 completion. |
...
| P4-04 — Numeric and bounded entry | 🟠 In progress | Input Number native scope accepted; Slider and Rate remain Planned. | [Input Number evidence](../components/input-number.md): native nullable value/validity/drafts and stepUp/stepDown, readonly/disabled distinction, no custom numeric engine. |
...
**Current component: Input Number (P4), verified native numeric editing/stepping scope.**
**P3 retained scope and P4-02's declared native scopes are complete; P4 is In progress.
Next: Slider, then Rate/native controls before Form enhancements. Do not infer P0 or full P4 completion.**
...
The index records 3,539 rows and 236 accepted retained tasks out of 384 across 59 component
pages (148 unchecked), not full upstream parity.
...
33 adapted targets + 13 omissions**. Four tasks close; totals are **3,539 rows and
...
**14,611/2,181/2,779**. P4-04 remains In progress for Slider and Rate.

The **11 remaining Planned P4 routes** are **Auto Complete, Color Picker,
Date Picker, Dynamic Input, Dynamic Tags, Form, Input OTP, Mention,
Rate, Slider, Time Picker**. Their historical 531 rows (528 unresolved and
three omissions) remain planning inventory, not implementation credit. Input/Checkbox/Radio/Switch/Select/Input Number
source supplements bring the P4 inventory to 853 rows without promoting other components.

**Next: Slider**, then Rate and other native controls before
