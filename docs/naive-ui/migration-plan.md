...
| P3 — Interaction foundations | 🟠 In progress | Popover retained native foundation accepted; Tooltip and the remaining P3 components are not complete. | P0 lifecycle; P1 controls | Nested interaction, dismissal and focus behavior are defined and demonstrated per component. |
...
| P3-04 — Tooltip and Popover | 🟠 In progress | Popover's retained native trigger/content scope is accepted; Tooltip is next, not yet implemented. | [Popover record](../components/popover.md): native state, delayed pointer/focus retention, cleanup and author-owned content. |
...
**Current component: Popover (P3), retained native nonmodal foundation accepted.**
**Next: Tooltip (P3), separate implementation/acceptance/commit; not started here.**
...
The index records 3,233 rows and 140 accepted retained tasks out of 384 across 35 component
pages (244 unchecked), not full upstream parity.
...
28 adapted targets are Verified, 21 omitted. P3 remains in progress; Tooltip is next.
...
### Remaining P3 inventory after Popover

The Image catalog check left 19 Planned P3-assigned components. Popover now closes its
four retained tasks; **18 P3-assigned components remain Planned**:
...
**Tooltip is next**, before later Popconfirm/Dropdown work. Popover's accepted native
foundation does not complete those inventories or global P3. Its 38 original public rows
remain, plus 11 source-only supplements: 28 Verified adapted targets and 21 omissions.
P2 remains complete for its 31 accepted adapted scopes, not all source parity.
No Tooltip code is implemented in this Popover change.
