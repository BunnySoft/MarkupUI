...
| Gradient Text | `GradientText` | [Demo and API](../../demo/components/gradient-text.html) |
...
| Transfer | `Transfer` | [Demo and API](../../demo/components/transfer.html) |
...
| Family | Elements / scope | Contract |
| --- | --- | --- |
| Collapse Transition | `CollapseTransition` | [Demo and API](../../demo/components/collapse-transition.html) |
