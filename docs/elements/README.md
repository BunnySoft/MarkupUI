...
Avatar and Button use the thin shared core; their API documentation is generated separately.
Button's payload acceptance remains pending; its demo describes the implemented API.
