...
> [platform architecture](../../architecture/README.md): platform-neutral component
...
| --- | --- | --- | --- |
| P0-01 | 🟢 Verified | Canonical core/plugin CSS and generated compatibility adapters. | Exact legacy runtime stylesheet hashes retained; [source map](foundations.md#authoring-sources-and-generated-modules). |
