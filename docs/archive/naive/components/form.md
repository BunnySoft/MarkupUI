...
The [2026-09-11 default-style audit](../../styling/components/form.md) aligns the
...
| [`inline`](https://github.com/tusen-ai/naive-ui/blob/42a52e6436b38bed456fee19eb0b89cdcd00fcc2/src/form/demos/enUS/index.demo-entry.md#L38) | Prop | `.m-form[data-inline]` wrapping flex. | 🟢 Verified | External CSS; native order. |
| [`label-width`](https://github.com/tusen-ai/naive-ui/blob/42a52e6436b38bed456fee19eb0b89cdcd00fcc2/src/form/demos/enUS/index.demo-entry.md#L39) | Prop | `--m-form-label-width` native CSS width. | 🟢 Verified | ADAPTED; global auto measurement omitted. |
| [`label-align`](https://github.com/tusen-ai/naive-ui/blob/42a52e6436b38bed456fee19eb0b89cdcd00fcc2/src/form/demos/enUS/index.demo-entry.md#L40) | Prop | Top labels default logical start, left labels logical end; `--m-form-label-align` overrides either. | 🟢 Verified | External CSS, RTL native order. |
...
| [`label-align`](https://github.com/tusen-ai/naive-ui/blob/42a52e6436b38bed456fee19eb0b89cdcd00fcc2/src/form/demos/enUS/index.demo-entry.md#L86) | Prop | --m-form-label-align logical CSS. | 🟢 Verified | Native RTL/layout. |
...
| [`label-width`](https://github.com/tusen-ai/naive-ui/blob/42a52e6436b38bed456fee19eb0b89cdcd00fcc2/src/form/demos/enUS/index.demo-entry.md#L90) | Prop | --m-form-label-width native width. | 🟢 Verified | Global measured auto sizing omitted. |
...
| [`label-style`](https://github.com/tusen-ai/naive-ui/blob/42a52e6436b38bed456fee19eb0b89cdcd00fcc2/src/form/demos/enUS/index.demo-entry.md#L89) | Prop | External label CSS. | 🟢 Verified | No style-object API. |
| [`label-width`](https://github.com/tusen-ai/naive-ui/blob/42a52e6436b38bed456fee19eb0b89cdcd00fcc2/src/form/demos/enUS/index.demo-entry.md#L90) | Prop | Native --m-form-label-width. | 🟢 Verified | No global measured auto labels. |
...
| [`span`](https://github.com/tusen-ai/naive-ui/blob/42a52e6436b38bed456fee19eb0b89cdcd00fcc2/src/grid/demos/enUS/index.demo-entry.md#L43) | Prop | --m-form-span / full span, or existing Grid CSS. | 🟢 Verified | Native responsive grid composition. |
