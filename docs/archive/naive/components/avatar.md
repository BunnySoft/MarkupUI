...
This page is the historical `9afc818` comparison record. Its old class names, flags, region
markers and load-order instructions are superseded by the
[canonical Avatar guide](../../components/avatar.md) and
[Element Contract reference](../../contracts/01-avatar.md).
...
The new [default-style audit](../../styling/components/avatar.md) supersedes the original
