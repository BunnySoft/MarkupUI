...
| [S4: standalone entry](../../../../src/components/button/index.ts) | `MButton`, `MButtonGroup`, `registerButton`; pre-existing conflicting definitions throw before registration. |
...
The [new default-style audit](../../styling/components/button.md) records the later
...
| [`text-color`](https://github.com/tusen-ai/naive-ui/blob/42a52e6436b38bed456fee19eb0b89cdcd00fcc2/src/button/demos/enUS/index.demo-entry.md#L56) | Prop | External `--m-button-label-color`; no inline style/object prop. | 🟢 Verified | A1/S3: narrower CSS-token replacement. |
...
| [`icon`](https://github.com/tusen-ai/naive-ui/blob/42a52e6436b38bed456fee19eb0b89cdcd00fcc2/src/button/demos/enUS/index.demo-entry.md#L72) | Slot | Direct authored `[data-m-button-icon]` node; decorative semantics and icon-only naming belong on native markup. | 🟢 Verified | A1/S1/S3: loading hides rather than discards icons. |
...
| Upstream item · source | Kind | Accepted MarkupUI mapping | Status | Evidence / retained limits |
| --- | --- | --- | --- | --- |
| [`spin-props.strokeWidth?`](https://github.com/tusen-ai/naive-ui/blob/42a52e6436b38bed456fee19eb0b89cdcd00fcc2/src/button/demos/enUS/index.demo-entry.md#L48) | Inline record field | External `--m-button-spinner-width` replaces the object/SVG stroke setting. | 🟢 Verified | A1/S3: narrower CSS spinner model, not record forwarding. |
| [`spin-props.stroke?`](https://github.com/tusen-ai/naive-ui/blob/42a52e6436b38bed456fee19eb0b89cdcd00fcc2/src/button/demos/enUS/index.demo-entry.md#L48) | Inline record field | External `--m-button-spinner-color` supplies spinner color. | 🟢 Verified | A1/S3: CSS replacement, no SVG prop object. |
