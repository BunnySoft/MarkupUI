...
[Default-style audit](../../styling/components/mention.md).
...
| [`on-update:show`](https://github.com/tusen-ai/naive-ui/blob/42a52e6436b38bed456fee19eb0b89cdcd00fcc2/src/mention/demos/enUS/index.demo-entry.md#L45) | Callback | m:mention-visibility for actual adjacent panel. | 🟢 Verified | Not source caret-popup visibility parity. |
...
| [`on-select`](https://github.com/tusen-ai/naive-ui/blob/42a52e6436b38bed456fee19eb0b89cdcd00fcc2/src/mention/demos/enUS/index.demo-entry.md#L47) | Callback | m:mention-select with chosen option/prefix after actual insertion. | 🟢 Verified | Explicit button/command action, not inferred from text equality. |
...
| [`on-search`](https://github.com/tusen-ai/naive-ui/blob/42a52e6436b38bed456fee19eb0b89cdcd00fcc2/src/mention/demos/enUS/index.demo-entry.md#L49) | Callback | Bounded loader/context and m:mention-search. | 🟢 Verified | No requests without eligible prefix/query; no built-in HTTP. |
