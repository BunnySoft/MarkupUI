...
The [Input OTP style audit](../../styling/components/input-otp.md) records actual
...
| [`block`](https://github.com/tusen-ai/naive-ui/blob/42a52e6436b38bed456fee19eb0b89cdcd00fcc2/src/input-otp/demos/enUS/index.demo-entry.md#L27) | Prop | `.m-input-otp[data-block]` native full width. | 🟢 Verified | External CSS only. |
...
| [`gap`](https://github.com/tusen-ai/naive-ui/blob/42a52e6436b38bed456fee19eb0b89cdcd00fcc2/src/input-otp/demos/enUS/index.demo-entry.md#L30) | Prop | --m-input-otp-gap letter spacing. | 🟢 Verified | ADAPTED single-field presentation, not inter-cell gaps. |
...
| [`on-finish`](https://github.com/tusen-ai/naive-ui/blob/42a52e6436b38bed456fee19eb0b89cdcd00fcc2/src/input-otp/demos/enUS/index.demo-entry.md#L39) | Callback | m:input-otp-complete with length/characters only. | 🟢 Verified | ADAPTED one-per-complete-stretch, no code payload/authentication/submit. |
