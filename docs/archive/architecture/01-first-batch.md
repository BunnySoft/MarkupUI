...
This page records the transitional first Web migration. The later
[Element Contract rewrite](../../elements/README.md) supersedes its `M*` class/base
naming while retaining validated behavior as implementation evidence.
The [full ViewElement rewrite](../../architecture/04-rewrite.md) supersedes this limited batch.
Its [class-owned metadata design](../../architecture/05-meta.md) is a subsequent refactor; historical
completion below does not mean `.meta` has been implemented.
