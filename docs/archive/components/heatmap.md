...
| [Complete reference](../naive/components/heatmap.md) | All 27 original identities plus explicit type/source/inherited additions |
...
were not changed. See the [default-style audit](../styling/components/heatmap.md).
