...
| [Reference](../naive/components/input-otp.md) | Original properties, callbacks, methods, slots, inline identities and explicit source supplements |
...
The [rendered style audit](../styling/components/input-otp.md) compares the pinned
