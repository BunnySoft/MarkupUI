...
See the [rendered report](../styling/components/data-table.md) for measured results and
...
| [Complete reference inventory](../naive/components/data-table.md) | Every original owner/member/type/inline identity and explicit source supplement |
...
The [reference tracker](../naive/components/data-table.md) is the exhaustive
