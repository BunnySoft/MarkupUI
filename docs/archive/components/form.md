...
| [Reference dispositions](../naive/components/form.md) | Original Form, item, inherited, slot, method and inline identities plus explicit source supplements |
...
**2026-09-11:** the [Form default-style audit](../styling/components/form.md)
