...
| [Complete reference](../naive/components/countdown.md) | Ten original identities plus four explicit source additions |

## Default-style audit — 2026-09-11

The [style review](../styling/components/countdown.md) is **Matched**. Pinned
...
[current catalog acceptance](../naive/index.md#countdown-accepted).
