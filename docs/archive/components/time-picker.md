...
platform time picker remains untouched. See the [measured audit](../styling/components/time-picker.md).
...
| [Reference](../naive/components/time-picker.md) | Every original identity and explicit source supplements |
...
recorded in the [master plan](../naive/migration-plan.md); no next collection was started.
