...
| [Reference](../naive/components/color-picker.md) | Original properties/slots/inline identities and explicit source supplements |

## Default-style audit — 2026-09-11

The [isolated rendered audit](../styling/components/color-picker.md) aligns the
