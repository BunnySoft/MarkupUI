...
remove, not silently suppressed. See the [rendered audit](../styling/components/list.md)
...
[reference tracker](../naive/components/list.md) keeps all ten original public rows and
