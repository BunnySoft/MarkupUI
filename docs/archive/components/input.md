...
| [Reference dispositions](../naive/components/input.md) | Every original owner/property/slot/method/inline field, plus explicit source supplements |
...
The [default-style audit](../styling/components/input.md) aligns the retained
...
All mappings are adaptations, not property passthrough. The [71-row reference](../naive/components/input.md)
