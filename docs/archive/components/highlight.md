...
The [reference tracker](../naive/components/highlight.md) preserves all **seven original
...
The [default-style audit](../styling/components/highlight.md) records the measured correction.
