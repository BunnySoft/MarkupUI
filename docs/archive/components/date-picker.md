...
| [Reference](../naive/components/date-picker.md) | Every original mode-specific identity and source supplement |
...
See the [default-style audit](../styling/components/date-picker.md).
...
Every original mode-specific row remains distinct in the [reference](../naive/components/date-picker.md).
