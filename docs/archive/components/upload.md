...
| [Complete reference](../naive/components/upload.md) | All 95 original identities plus six explicit source additions |
...
The [rendered Upload style audit](../styling/components/upload.md) compares the
...
[current index acceptance](../naive/index.md#upload-accepted).
