...
| [Reference](../naive/components/tree.md) | 119 preserved original identities plus explicit supplements/dispositions |
...
See the [rendered Tree style audit](../styling/components/tree.md) for measurements,
