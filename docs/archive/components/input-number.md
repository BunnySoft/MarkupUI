...
| [Pinned dispositions](../naive/components/input-number.md) | Every original owner/prop/slot/method/inline identity and explicit supplements |
...
The [default-style audit](../styling/components/input-number.md) records measured
