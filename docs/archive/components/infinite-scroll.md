...
| [Complete reference](../naive/components/infinite-scroll.md) | Original identities and explicit source supplements |
...
The [default-style audit](../styling/components/infinite-scroll.md) records why the
...
[Reference tracker](../naive/components/infinite-scroll.md): **three original identities
...
[default-style audit](../styling/components/infinite-scroll.md) narrows the maintained
