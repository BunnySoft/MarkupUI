...
The [isolated rendered audit](../styling/components/select.md) corrects native
...
| [Reference inventory](../naive/components/select.md) | All original props, option/group records, slots, methods and inline fields |
