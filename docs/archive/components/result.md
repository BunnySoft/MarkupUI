...
The [reference tracker](../naive/components/result.md) preserves **seven original rows**
...
See the [rendered Result visual audit](../styling/components/result.md) for the
