...
option-rendering differences retained.** See the [rendered report](../styling/components/popselect.md)
...
| [Complete reference](../naive/components/popselect.md) | Every original/local/inherited identity plus explicit source supplements |
...
[Reference tracker](../naive/components/popselect.md): **56 original identities
