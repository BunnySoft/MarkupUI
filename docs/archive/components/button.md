...
contains its original basic controller. The new [default-style audit](../styling/components/button.md)
...
[motion evidence and exact blocker](../styling/components/button.md#motion-follow-up-integrated-wave-and-insertion).
...
[Read the current usage and API](../../../demo/components/button.html).
