...
**2026-09-11 default-style audit:** [not applicable](../styling/components/qr-code.md).
...
opaque text. No JavaScript is needed. The [complete reference](../naive/components/qr-code.md)
