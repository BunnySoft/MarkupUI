...
The [reference tracker](../naive/components/code.md) retains seven original rows and
...
See the [rendered Code visual audit](../styling/components/code.md) for exact colors,
