...
| [Reference](../naive/components/dynamic-input.md) | All original owner/source/kind identities and explicit supplements |

## Default-style audit — 2026-09-11

The [isolated rendered audit](../styling/components/dynamic-input.md) aligns the
