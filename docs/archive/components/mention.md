...
See the [measured audit](../styling/components/mention.md).
...
| [Reference dispositions](../naive/components/mention.md) | All original owner/source/kind identities plus explicit source supplements |
