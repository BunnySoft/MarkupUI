...
| [Reference](../naive/components/tree-select.md) | Original identities and explicit source supplements/dispositions |
...
[rendered style audit](../styling/components/tree-select.md) records the actual
