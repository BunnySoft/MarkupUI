...
| [Pinned dispositions](../naive/components/radio.md) | Every original grouped owner/property/inline identity, plus explicit source supplements |
...
The [default-style audit](../styling/components/radio.md) aligns native circle
