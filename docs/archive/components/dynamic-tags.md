...
See the [measured audit](../styling/components/dynamic-tags.md).
...
| [Reference](../naive/components/dynamic-tags.md) | Original identities plus explicit source supplements |
