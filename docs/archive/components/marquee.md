...
| [Complete pinned mapping](../naive/components/marquee.md) | Three original identities plus eight explicitly sourced additions |
...
[rendered default-style audit](../styling/components/marquee.md) supersedes its CSS
