...
| [Pinned dispositions](../naive/components/checkbox.md) | All 29 original identities plus 13 explicit source supplements |
...
The [default-style audit](../styling/components/checkbox.md) records exact geometry,
