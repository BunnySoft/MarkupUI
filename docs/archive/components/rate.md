...
| [Reference dispositions](../naive/components/rate.md) | All original owner/prop/slot/inline identities and explicit supplements |
...
[rendered Rate audit](../styling/components/rate.md) for these artwork/state limits.
