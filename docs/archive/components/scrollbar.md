...
The [reference tracker](../naive/components/scrollbar.md) preserves all **16 original
...
See the [Scrollbar style audit](../styling/components/scrollbar.md) for the actual
