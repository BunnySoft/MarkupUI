...
| [Pinned dispositions](../naive/components/switch.md) | All 23 original identities plus eight explicit source supplements |
...
The [default-style audit](../styling/components/switch.md) records actual geometry,
