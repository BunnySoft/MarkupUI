...
native-sticky contract and was **left unchanged**. The [comparison report](../styling/components/affix.md)
...
The [reference tracker](../naive/components/affix.md) keeps six original rows and four
