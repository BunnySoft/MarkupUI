...
The [isolated light/dark audit](../styling/components/global-style.md) now matches
...
The [Avatar default-style audit](../styling/components/avatar.md) verifies the 14px/1.6
...
That absence is preserved. The [reference record](../naive/components/global-style.md)
...
The [master P0 task table](../naive/migration-plan.md#p0--architecture-and-contracts)
