...
| [Pinned dispositions](../naive/components/slider.md) | All original identities plus explicit source supplements/omissions |
...
The [default-style audit](../styling/components/slider.md) aligns the ordinary
