...
The [2026-09-11 default-style review](../styling/components/config-provider.md)
...
The [pinned reference tracker](../naive/components/config-provider.md) preserves every
