...
The [rendered audit](../styling/components/transfer.md) documents substantial remaining
...
| [Reference](../naive/components/transfer.md) | Every original identity and explicit source supplements |
