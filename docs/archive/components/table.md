...
The [reference tracker](../naive/components/table.md) preserves the **six original
...
The [rendered Table audit](../styling/components/table.md) distinguishes the matching
