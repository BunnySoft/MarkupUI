...
The [2026-09-11 default-style review](../styling/components/discrete.md) is
...
selection. This discrepancy is preserved in the [reference tracker](../naive/components/discrete.md);
...
Start with **[Input](../naive/components/input.md)**: native input/textarea adoption,
...
**[Form](../naive/components/form.md)** enhancement/async validation. Relevant native P0
