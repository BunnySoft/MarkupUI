...
**2026-09-11 default-style audit:** [matched inherited text](../styling/components/time.md).
...
| [Complete reference](../naive/components/time.md) | Six original identities and three explicit source additions |
...
[current index acceptance](../naive/index.md#time-accepted).
