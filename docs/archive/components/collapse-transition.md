...
[rendered motion audit](../styling/components/collapse-transition.md) for concrete samples.
...
The [reference tracker](../naive/components/collapse-transition.md) retains all original
