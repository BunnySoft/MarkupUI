...
remain deliberate differences. See the [measured audit](../styling/components/watermark.md).
...
| [Complete reference](../naive/components/watermark.md) | All 27 original rows plus four explicit source additions |
...
are recorded in the [current catalog acceptance](../naive/index.md#watermark-accepted).
