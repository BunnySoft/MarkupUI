...
toolbar differences retained.** The [2026-09-10 rendered report](../styling/components/image.md)
...
The [reference tracker](../naive/components/image.md) preserves all 77 original rows
