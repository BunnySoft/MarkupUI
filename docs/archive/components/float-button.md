...
The [reference tracker](../naive/components/float-button.md) retains **20 original rows**
...
See the [rendered FloatButton audit](../styling/components/float-button.md) for actual
