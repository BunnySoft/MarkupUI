...
| [Full reference](../naive/components/calendar.md) | Every original identity and explicit source/inline/inherited addition |

## Default-style audit — 2026-09-11

The [isolated style audit](../styling/components/calendar.md) aligns Calendar's
...
the [current catalog acceptance](../naive/index.md#calendar-accepted).
