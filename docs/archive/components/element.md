...
**2026-09-11 default-style audit:** [not applicable](../styling/components/element.md).
...
The [reference tracker](../naive/components/element.md) retains both original public
