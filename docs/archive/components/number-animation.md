...
**2026-09-11 default-style audit:** [matched inherited text](../styling/components/number-animation.md).
...
| [Complete reference](../naive/components/number-animation.md) | Nine original identities and three explicit source additions |
...
[current index acceptance](../naive/index.md#number-animation-accepted).
