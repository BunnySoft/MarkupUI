...
function initialize() {
  const api = globalThis.MarkupUIAvatar
  if (!api) throw new Error("Avatar runtime did not load.")
  void loadComponentApi(document.getElementById("avatar-api"), new URL("../api/avatar.json", import.meta.url))
