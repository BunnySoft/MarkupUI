...
root.addEventListener("m:radio-group-change", () => { counts.radio++; render() })
root.addEventListener("m:rate-clear", () => { counts.clear++; render() })
root.addEventListener("m:radio-group-error", render)
root.addEventListener("m:rate-error", render)
