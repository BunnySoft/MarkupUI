...
export function styleModule(style, css) {
  return `// Generated from ${style.css} by scripts/styles.mjs. Edit the CSS source.\nexport const ${style.name} = ${JSON.stringify(normalizeLines(css))}\n`
}
...
export function themeModule(themes) {
  return `// Generated from src/theme/presets.json by scripts/styles.mjs. Edit the JSON source.\nexport const builtInThemeTokens = ${JSON.stringify(validateThemes(themes), null, 2)}\n`
}
...
export async function generateStyleModules(root) {
...
export async function emitStylesheets(root, dist) {
  for (const style of styles) {
