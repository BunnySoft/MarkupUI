...
for (const name of [...components, ...styleOnlyComponents]) {
  ...
  if (components.includes(name)) {
    for (const [mode, suffix] of [["esm", ".js"], ["classic", ".global.js"]]) {
      ...
      const runtimeBudget = viewComponents.get(name) ?? (name === "rate" ? 8_000 : name === "tree-select" ? 12_000 : name === "popselect" ? 13_500 : undefined)
