...
const styleOnlyComponents = ["gradient-text", "timeline", "thing", "affix", "code", "scrollbar", "float-button", "global-style"]
classicEntries.avatar = "global.ts"
classicEntries.button = "global.ts"
classicEntries.card = "global.ts"
components.push("divider", "icon", "typography", "space", "flex", "grid", "layout", "list", "table", "descriptions", "breadcrumb", "page-header", "ellipsis", "result")
