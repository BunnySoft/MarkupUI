...
const styleOnlyComponents = ["gradient-text", "ellipsis", "page-header", "grid", "layout", "list", "descriptions", "timeline", "breadcrumb", "thing", "table", "affix", "result", "code", "scrollbar", "float-button", "global-style"]
classicEntries.avatar = "global.ts"
classicEntries.button = "global.ts"
classicEntries.card = "global.ts"
components.push("divider", "icon", "typography", "space", "flex")
