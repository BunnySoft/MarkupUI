...
const components = ["avatar", "button", "card", "tag", "badge", "alert", "empty", "skeleton", "spin", "progress", "statistic", "highlight", "image", "popover", "tooltip", "popconfirm"]
const classicEntries = { progress: "global.ts", popover: "global.ts", tooltip: "global.ts", popconfirm: "global.ts" }
...
await Promise.all([...components, ...styleOnlyComponents].map(async (name) => {
  ...
  if (name === "tooltip" || name === "popconfirm") {
